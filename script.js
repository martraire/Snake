...
{
    snakeGame = new SnakeGame(900,600,30,400);
...
function SnakeGame(canvasWidth, canvasHeight, blockSize, delay)
{
    ...
    this.canvas.style.border = "30px solid #2B548A";
    this.canvas.style.margin = "50px auto";
    this.canvas.style.display = "block";
    this.canvas.style.backgroundColor = "#DBEAFE";   
    ...
    this.gameOver = function()
    {
        ...
        this.ctx.strokeText("Game Over", centreX, centreY - 200);
        this.ctx.fillText("Game Over", centreX, centreY - 200);
        this.ctx.font = "bold 30px sans-serif";
        this.ctx.strokeText("Appuyer sur la touche Espace pour rejouer", centreX, centreY - 140);
        this.ctx.fillText("Appuyer sur la touche Espace pour rejouer", centreX, centreY - 140);
        this.ctx.restore();
    };
